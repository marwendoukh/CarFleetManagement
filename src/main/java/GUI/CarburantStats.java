 ...
 * @author Marwen
 */
public class CarburantStats extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarburantStats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
