 ...
 * @author Marwen
 */
public class FixingStats extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FixingStats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
