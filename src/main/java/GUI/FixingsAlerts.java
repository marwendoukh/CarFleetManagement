 ...
 * @author Moez
 */
public class FixingsAlerts extends javax.swing.JFrame {

    /**
     * Creates new form InterfaceDesAlertesVehicule
     */
    public FixingsAlerts() {
        initComponents();

        FixingDAO fixingDao = new FixingDAO();

        List<Car> alerts = fixingDao.findCoutKilometrique();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FixingsAlerts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
