 ...
 * @author Marwen
 */
public class MagasinStats extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MagasinStats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
